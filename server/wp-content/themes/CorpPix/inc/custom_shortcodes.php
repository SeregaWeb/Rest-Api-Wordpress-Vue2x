			...
			foreach($latest as $post) {
                ...
                <div class="item <?php echo $custom_class_item; ?>">
                    ...
                    <div class="wrapInfo">
                        ...
                        <p><?php echo $pixlab->px_string_limit_words($excerpt,$excerpt_count) ?></p>
    ...
    function share_colection($atts, $content = null) {
        ...
        <div class="share-block-wrap">
            <div class="share-block text-left">
                <div class="share-block-item">
                    <p class="share">Поделиться: </p>
                    <a href="http://www.facebook.com/sharer.php?u=<?php echo get_permalink(); ?>" target="_blank" class="facebook social"></a>
                    
                    <a href="https://www.pinterest.com/pin/create/bookmarklet/?description=<?=get_the_title($id)?>&url=<?php echo get_permalink(); ?>" target="_blank" class="pinterest social"></a>
                </div>
            </div>
        </div>
